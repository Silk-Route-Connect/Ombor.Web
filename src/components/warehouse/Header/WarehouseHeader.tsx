...
/** Archive toggle per the bundle's `.arch-toggle` (mirrors the Products header). */
const ArchiveToggle: React.FC<{
	...
	return (
		<ButtonBase
			onClick={() => onToggle(!on)}
			title={t("warehouse.filter.archiveTooltip")}
			sx={{
				display: "inline-flex",
				alignItems: "center",
				gap: "8px",
 ...
 * «Экспорт») sit on the title row; the view-shaping search + archive toggle sit
