...
- **Rewrite-as-we-go:** existing modules (Products, Partners, Employees, Transactions, Categories, Payroll) are legacy side-pane style until rebuilt to the redesign. Structure and approach (stores/api/models/schemas) stay; components and layouts are replaced per module.
