...
/**
 * Archived-state banner per the bundle's `.arch-banner`: surface-sub strip
 * with a saffron accent edge and the restore hint.
 */
export const ProductArchivedBanner: React.FC = () => {
		...
		>
			...
			<Typography sx={{ fontSize: 13, color: designTokens.gray700, lineHeight: 1.55 }}>
				<Box component="b" sx={{ color: "text.primary", fontWeight: 700 }}>
					{t("product.detail.archived.title")}
				</Box>{" "}
