...
| F13 | **Wallet transfer over-balance guard** blocks all transfers from a negatively-balanced wallet (needs `Math.max(available,0)`) | Latent | Important | `WalletTransferModal.tsx:158` |
