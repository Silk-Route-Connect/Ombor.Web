...
/**
 * Autogenerated SKU: the initials of each word of the product name (native
 * script, upper-cased) + 4 digits, e.g. «Молоко Пастеризованное» → "МП-1234".
 * Falls back to a plain "SKU-1234" when no name has been entered yet.
 */
const generateSku = (name?: string): string => {
	...
	return `${initials || "SKU"}-${Math.floor(1000 + Math.random() * 9000)}`;
};
...
const ProductFormModal: React.FC<ProductFormModalProps> = ({
	...
	const handleGenerateSku = () =>
		form.form.setValue("sku", generateSku(form.form.getValues("name")), {
			shouldDirty: true,
			shouldValidate: true,
		});
