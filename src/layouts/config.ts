...
/** A titled section in the sidebar (design: uppercase group label + items). */
...
export const navSections: NavSection[] = [
	{
		label: translate("sidebar.group.overview"),
		items: [{ label: translate("sidebar.dashboard"), to: "/", icon: DashboardOutlinedIcon }],
	},
	{
		label: translate("sidebar.group.catalog"),
		items: [
			{
	...
	{
		label: translate("sidebar.group.team"),
		items: [
			{
