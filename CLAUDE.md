...
- **Not yet built:** Stock Adjustments, Transfers, Orders (+ New Order), Wallets, Debts, Settings, Reports; Sales/Supplies as separate pages (currently one TransactionPage).
